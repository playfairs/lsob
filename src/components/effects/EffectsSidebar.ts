...
export function EffectsSidebar() {
  const groups = buildEffectGroups(
    editorState.effects,
    editorState.searchQuery,
  );
  const selected = getEffectById(
    editorState.effects,
    ...
    <section class="panel effects-panel">
      ...
      <div class="effect-groups">
        ...
        `,
                ...
                .join("")
            : `<div class="empty-filter-state">No effects match your search.</div>`
        }
      </div>
      ...
      <div class="effect-stack">
        ...
        ${
          editorState.effectStack.length
        ...
        `,
                ...
                .join("")
            : `<div class="empty-filter-state">Select an effect to add it here.</div>`
        }
      </div>
